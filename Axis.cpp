///*******************************************************************************
// $Archive: /ClearPath SC/Installer/Program Files/Teknic/ClearView/sdk/examples/6-Example-SingleThreaded(Polling)/Axis.cpp $
// $Revision: 11 $ $Date: 11/22/16 4:02p $
//
// NAME
//		Axis
//
...
void Axis::AxisMain() {
	...
	if (!m_quitting) {
		...
		SetBrakeControl(0, BrakeControls::BRAKE_ALLOW_MOTION);
