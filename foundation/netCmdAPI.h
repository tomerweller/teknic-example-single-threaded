//******************************************************************************
// $Workfile: netCmdAPI.h $
// $Archive:: /ClearPath SC-1.0.123/User Driver/inc/netCmdAPI.h               $
// $Revision: 54 $ $Date: 12/09/16 2:02p $
//
// NAME
//		netCmdAPI.h
//
...
MN_EXPORT cnErrCode MN_DECL netEnterBypassMode(
		multiaddr theMultiAddr_nodeException);
...
MN_EXPORT cnErrCode MN_DECL netGetNodeAccessLvl(
		multiaddr theNet,				// Destination node
