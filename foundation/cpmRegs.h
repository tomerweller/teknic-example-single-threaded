...
// $Revision: 4 $ $Date: 12/09/16 4:16p $
// $Workfile: cpmRegs.h $
//
/// \file
...
//
// DESCRIPTION:
///		This header file defines the private ClearPath-SC motor node registers.
//
// CREATION DATE:
//		12/21/2011 
//
...
typedef enum _cpmCmds {
    ...
    SC_CMD_NET_ACCESS = MN_CMD_NET_ACCESS, // 5 Get access level
